...
export default function ResultsPage() {
  ...
  return <main className="app-page"><KelusHeader /><div className="results-search"><SearchControls compact defaultProduct="iPhone 17"/></div>
    ...
    </div><aside className="insights-panel"><div className="product-summary"><span className="product-mark"><span>IPH</span></span><div><p className="eyebrow">Product overview</p><h2>{featuredProduct.name}</h2><p>256GB · New & used</p></div></div><div className="insight-card"><span className="insight-label">Best price today</span><strong>$749</strong><p>That is $50 below the six-month average.</p><a href="/compare/iphone-17" className="text-link">Compare all trade-offs <Icon name="arrow" size={15}/></a></div><div className="insight-card"><div className="insight-title"><span>Price history</span><b>Good time to buy</b></div><PriceChart points={priceHistory}/><p>Prices are at their lowest point in six months.</p></div></aside></section>
  </main>;
}
