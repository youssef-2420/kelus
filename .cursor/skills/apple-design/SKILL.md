...
name: apple-design
alwaysApply: true
description: DEFAULT Kelus UI skill (with framer-motion-ui). Use for every UI/UX tweak, layout, typography, spacing, press feedback, and interaction review. Apple's approach to interface design and fluid, physical motion, translated for the web. Pair with framer-motion-ui for implementation. On Kelus, bounce is 0.
---

# Apple Design

**Kelus default, paired with `framer-motion-ui`.** Use this skill for UI/UX work. Springs use bounce 0.
