---
name: shadcn
description: NOT the default Kelus UI skill. Use only when the user explicitly asks about shadcn/ui, the component registry, presets, or components.json. Do not use for ordinary Kelus homepage or product visual tweaks — those use apple-design and framer-motion-ui.
