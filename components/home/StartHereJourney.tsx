      ...
      <div className="start-route">
        <svg className="start-route-line" viewBox="0 0 1000 32" preserveAspectRatio="none" aria-hidden="true">
          ...
          <motion.path
            ...
            transition={{ duration: reduceMotion ? 0 : kelusDuration.slow, ease: kelusEase }}
          />
        </svg>
        ...
        >
          <motion.li variants={reveal} transition={{ duration: reduceMotion ? kelusDuration.micro : kelusDuration.moderate, ease: kelusEase }}>
