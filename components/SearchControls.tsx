...
type Props = { compact?: boolean; minimal?: boolean; minimalAction?: boolean; initialCriteria?: SearchCriteria; resultPath?: string; actionLabel?: string };
const conditionLabels: Record<ConditionFilter, string> = { any: "Any", new: "New", used: "Used", refurbished: "Refurbished" };

export function SearchControls({ compact = false, minimal = false, minimalAction = false, initialCriteria = defaultSearch, resultPath = "/results-v2", actionLabel = "Search" }: Props) {
