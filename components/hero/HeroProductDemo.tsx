...
/** Interactive Kelus route example — product stage below the hero, not inside it. */
export function HeroProductDemo() {
  ...
  return (
    <div className="hero-product-demo folio-product-demo" aria-label="Interactive example of a Kelus study route">
