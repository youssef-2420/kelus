...
export function KelusHero() {
  ...
  return (
    <section className="kelus-hero home-hero is-product-demo is-editorial is-narrative" aria-labelledby="home-hero-title">
      <div className="hero-atmosphere" aria-hidden="true">
        <span className="hero-atmosphere-mist" />
        <span className="hero-atmosphere-wash" />
        <span className="hero-atmosphere-beam" />
        <span className="hero-atmosphere-grain" />
        <span className="hero-atmosphere-horizon" />
      ...
      <motion.div
        ...
        transition={reduceMotion ? { duration: 0 } : { duration: 0.65, delay: 0.12, ease }}
      >
        <div className="hero-stage-ensemble">
          <span className="hero-stage-horizon" aria-hidden="true" />
          <span className="hero-stage-floor" aria-hidden="true" />

          <div className="hero-stage-art">
            <StudentIllustration className="hero-stage-student" />
          </div>
