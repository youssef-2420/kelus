...
export function OfferCard({ offer }: { offer: Offer }) {
  return <article className="offer-card">
    ...
    <div className="offer-footer"><span className="score"><b>{offer.score}</b>/100 Kelus score</span><Link className="text-link" href="/compare/iphone-17">Review offer <Icon name="arrow" size={15}/></Link></div>
  </article>;
}
