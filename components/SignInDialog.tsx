...
export function SignInDialog() {
  ...
  function switchMode(next: "signin" | "create") { setNotice(""); setMode(next); }
  useEffect(() => {
    if (!open) return;
