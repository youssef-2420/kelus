...
export function MaterialToMapIllustration({ reduceMotion }: { reduceMotion: boolean }) {
  return (
    <figure className="how-illustration how-material-map">
      <svg viewBox="0 0 640 320" role="img" aria-labelledby="material-map-title material-map-desc">
        ...
        <desc id="material-map-desc">Two course documents on the left connect to Supply and Demand, Elasticity, and Market Structures on the right.</desc>
        ...
        <g className="how-concept-node"><circle cx="378" cy="78" r="7" /><text x="396" y="82">Supply &amp; Demand</text></g>
        <g className="how-concept-node is-primary"><circle cx="406" cy="158" r="11" /><text x="428" y="162">Elasticity</text></g>
        <g className="how-concept-node"><circle cx="396" cy="238" r="7" /><text x="414" y="242">Market Structures</text></g>
...
export function TodayRouteIllustration({ reduceMotion }: { reduceMotion: boolean }) {
  return (
    <figure className="how-illustration how-route-figure">
      <svg viewBox="0 0 640 320" role="img" aria-labelledby="today-route-title today-route-desc">
        ...
        <desc id="today-route-desc">Kelus chooses a path from the learner through Elasticity and Market Structures toward the exam, while alternative paths remain faint.</desc>
        ...
        <g className="how-route-node"><circle cx="266" cy="168" r="8" /><text x="266" y="146">ELASTICITY</text><text x="266" y="194">18 MIN</text></g>
        <g className="how-route-node"><circle cx="448" cy="108" r="8" /><text x="448" y="86">MARKETS</text><text x="448" y="134">10 MIN</text></g>
...
export function RerouteIllustration({ reduceMotion }: { reduceMotion: boolean }) {
  return (
    <figure className="how-illustration how-reroute-figure">
      <svg viewBox="0 0 640 320" role="img" aria-labelledby="reroute-title reroute-desc">
        ...
        <desc id="reroute-desc">An Almost answer updates Elasticity from 42 to 54 percent and moves Monetary Policy forward in the next route.</desc>
        ...
        <g className="how-mastery-shift">
          <text x="286" y="128">ELASTICITY</text>
        ...
        <g className="how-next-route">
          ...
          <text x="442" y="82">01</text><text x="478" y="82">Elasticity</text>
          <text className="is-moved" x="442" y="114">02</text><text className="is-moved" x="478" y="114">Monetary Policy ↑</text>
          <text x="442" y="146">03</text><text x="478" y="146">Market Structures</text>
        </g>
