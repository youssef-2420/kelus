...
export const MATERIALS_INTERACTIONS: MicroInteraction[] = [
  ...
  },
  {
    ...
    gesture: "None.",
    keyboardAlt: "Tab through proposals; Space toggles; Enter on Confirm topics CTA.",
    a11y: "Checkbox labelled by name input id; focus move on phase enter.",
  },
  {
    name: "Confirm → diagnosis",
    trigger: "CONFIRM success.",
    rules: "Persist concepts then router.replace(/today) into diagnosis — no blocking ready hop.",
    feedback: "CTA press; navigation into familiarity check.",
    duration: "Immediate navigation after confirm.",
    gesture: "None.",
    keyboardAlt: "Enter on Confirm topics CTA.",
    a11y: "Diagnosis heading should receive focus on arrival.",
  },
];
